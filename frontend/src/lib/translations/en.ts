export const en = {
  ...
  browseModpacksDesc: 'Search and select a modpack from CurseForge or Modrinth',
  browse: 'Browse',
  ...
  modpackTemplatesDescription: 'Discover and install modpacks from CurseForge or Modrinth',
  ...
  modrinthProjectSlugDesc: 'Used by the server to install this modpack from Modrinth.',
  ...
  fabricVanillaDesc: 'Modern, lightweight mod loader. Great performance and quick updates.',
  fabricCreative: 'Fabric Creative',
  fabricCreativeDesc: 'Creative mode on Fabric. Build freely with the option to add mods later.',
  forgeVanilla: 'Forge Survival',
  forgeVanillaDesc: 'Classic Forge mod loader. Huge modding ecosystem for older Minecraft versions.',
  forgeCreative: 'Forge Creative',
  forgeCreativeDesc: 'Creative mode on Forge. Perfect for testing large mod builds.',
  neoforgeVanilla: 'Neoforge Survival',
  neoforgeVanillaDesc: 'Modern Forge fork with better performance and active development.',
  createServerModrinthModpackDesc: 'Install a modpack from Modrinth. You will pick the modpack in the next step.',
  createServerCurseforgeModpackDesc: 'Install a modpack from CurseForge. You will pick the modpack in the next step.',
  modpackNextStep: 'After creating the server, open the Mods/Modpack tab in Server Settings to pick which pack to install.',
  ...
  templateCategorySpecialty: 'Specialty',
  skyblock: 'SkyBlock',
