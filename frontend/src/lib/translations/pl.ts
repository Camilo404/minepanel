...
export const pl: Record<TranslationKey, string> = {
  ...
  browseModpacks: 'Przeglądaj modpacki',
  browseModpacksDesc: 'Wyszukaj i wybierz modpack z CurseForge lub Modrinth',
  browse: 'Przeglądaj',
  ...
  modpackTemplatesDescription: 'Wykryj i zainstaluj pakiety modów z CurseForge lub Modrinth',
  ...
  viewOnModrinth: 'Wyświetl w Modrinth',
  close: 'Zamknij',
  modrinthProjectSlug: 'Slug projektu Modrinth',
  modrinthProjectSlugDesc: 'Używany przez serwer do zainstalowania tego pakietu modów z Modrinth.',
  projectSlug: 'Slug projektu',
  downloadUrl: 'URL pobierania',
  loaders: 'Loadery',
  featured: 'Polecane',
  ...
  fabricVanilla: 'Przetrwanie na Fabric',
  fabricVanillaDesc: 'Nowoczesny, lekki loader modów. Dobra wydajność i szybkie aktualizacje.',
  fabricCreative: 'Kreatywny na Fabric',
  fabricCreativeDesc: 'Tryb kreatywny na Fabric. Buduj swobodnie z opcją dodania modów później.',
  forgeVanilla: 'Przetrwanie na Forge',
  forgeVanillaDesc: 'Klasyczny loader modów Forge. Ogromny ekosystem modów dla starszych wersji Minecraft.',
  forgeCreative: 'Kreatywny na Forge',
  forgeCreativeDesc: 'Tryb kreatywny na Forge. Idealny do testowania dużych buildów z modami.',
  neoforgeVanilla: 'Przetrwanie na Neoforge',
  neoforgeVanillaDesc: 'Nowoczesny fork Forge z lepszą wydajnością i aktywnym rozwojem.',
  createServerModrinthModpackDesc: 'Zainstaluj modpack z Modrinth. Modpack wybierzesz w następnym kroku.',
  createServerCurseforgeModpackDesc: 'Zainstaluj modpack z CurseForge. Modpack wybierzesz w następnym kroku.',
  modpackNextStep: 'Po utworzeniu serwera otwórz zakładkę Mods/Modpack w Ustawieniach serwera, aby wybrać paczkę do zainstalowania.',
  templateCategoryVanilla: 'Vanilla',
  templateCategoryPaper: 'Paper (Pluginy)',
  templateCategoryFabric: 'Fabric (Mody)',
  templateCategoryForge: 'Forge (Mody)',
  templateCategoryNeoforge: 'Neoforge (Mody)',
  templateCategoryModpack: 'Modpacki',
  templateCategorySpecialty: 'Specjalne',
  skyblock: 'SkyBlock',
  ...
  streamLive: 'Na żywo',
  streamReconnecting: 'Ponowne łączenie...',
  streamOffline: 'Strumień offline',
  streamError: 'Błąd strumienia na żywo',
