...
export const de: Record<TranslationKey, string> = {
  ...
  browseModpacksDesc: 'Suchen und wählen Sie ein Modpack von CurseForge oder Modrinth',
  browse: 'Durchsuchen',
  ...
  modpackTemplatesDescription: 'Entdecken und installieren Sie Modpacks von CurseForge oder Modrinth',
  ...
  viewOnModrinth: 'Auf Modrinth anzeigen',
  close: 'Schließen',
  modrinthProjectSlug: 'Modrinth-Projekt-Slug',
  modrinthProjectSlugDesc: 'Vom Server verwendet, um dieses Modpack von Modrinth zu installieren.',
  ...
  fabricVanilla: 'Fabric Überleben',
  fabricVanillaDesc: 'Moderner, leichtgewichtiger Modloader. Gute Performance und schnelle Updates.',
  fabricCreative: 'Fabric Kreativ',
  fabricCreativeDesc: 'Creative-Modus auf Fabric. Baue frei und füge später Mods hinzu.',
  forgeVanilla: 'Forge Überleben',
  forgeVanillaDesc: 'Klassischer Forge-Modloader. Riesiges Mod-Ökosystem für ältere Minecraft-Versionen.',
  forgeCreative: 'Forge Kreativ',
  forgeCreativeDesc: 'Creative-Modus auf Forge. Perfekt zum Testen großer Mod-Builds.',
  neoforgeVanilla: 'Neoforge Überleben',
  neoforgeVanillaDesc: 'Moderner Forge-Fork mit besserer Performance und aktiver Entwicklung.',
  createServerModrinthModpackDesc: 'Installiere ein Modpack von Modrinth. Du wählst das Modpack im nächsten Schritt.',
  createServerCurseforgeModpackDesc: 'Installiere ein Modpack von CurseForge. Du wählst das Modpack im nächsten Schritt.',
  modpackNextStep: 'Öffne nach dem Erstellen des Servers den Mods/Modpack-Tab in den Servereinstellungen, um das zu installierende Pack auszuwählen.',
  ...
  templateCategorySpecialty: 'Spezial',
  skyblock: 'SkyBlock',
  ...
  streamLive: 'Live',
  streamReconnecting: 'Verbinde erneut...',
  streamOffline: 'Stream offline',
  streamError: 'Livestream-Fehler',
