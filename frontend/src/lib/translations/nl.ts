...
export const nl: Record<TranslationKey, string> = {
  ...
  searchServers: 'Servers zoeken...',
  filterAll: 'Alle',
  javaEdition: 'Java',
  bedrockEdition: 'Bedrock',
  noMotd: 'Geen beschrijving',
  noServersFound: 'Geen servers gevonden voor je zoekopdracht',
  noServersFoundDesc: 'Probeer je zoekopdracht of filter aan te passen om te vinden wat je zoekt',
  ...
  browseModpacksDesc: 'Zoek en selecteer een modpack van CurseForge of Modrinth',
  browse: 'Bladeren',
  ...
  modpackTemplatesDescription: 'Ontdek en installeer modpacks van CurseForge of Modrinth',
  ...
  viewOnModrinth: 'Bekijk op Modrinth',
  close: 'Sluiten',
  modrinthProjectSlug: 'Modrinth Project Slug',
  modrinthProjectSlugDesc: 'Door de server gebruikt om dit modpack van Modrinth te installeren.',
  ...
  fabricVanilla: 'Fabric Survival',
  fabricVanillaDesc: 'Moderne, lichte mod-loader. Goede prestaties en snelle updates.',
  fabricCreative: 'Fabric Creative',
  fabricCreativeDesc: 'Creative-modus op Fabric. Bouw vrij en voeg later mods toe.',
  forgeVanilla: 'Forge Survival',
  forgeVanillaDesc: 'Klassieke Forge mod-loader. Groot mod-ecosysteem voor oudere Minecraft-versies.',
  forgeCreative: 'Forge Creative',
  forgeCreativeDesc: 'Creative-modus op Forge. Perfect voor het testen van grote mod-builds.',
  neoforgeVanilla: 'Neoforge Survival',
  neoforgeVanillaDesc: 'Moderne Forge-fork met betere prestaties en actieve ontwikkeling.',
  createServerModrinthModpackDesc: 'Installeer een modpack van Modrinth. Je kiest het modpack in de volgende stap.',
  createServerCurseforgeModpackDesc: 'Installeer een modpack van CurseForge. Je kiest het modpack in de volgende stap.',
  modpackNextStep: 'Open na het maken van de server het Mods/Modpack-tabblad in Serverinstellingen om te kiezen welk pack je wilt installeren.',
  templateCategoryVanilla: 'Vanilla',
  templateCategoryPaper: 'Paper (Plugins)',
  templateCategoryFabric: 'Fabric (Mods)',
  templateCategoryForge: 'Forge (Mods)',
  templateCategoryNeoforge: 'Neoforge (Mods)',
  templateCategoryModpack: 'Modpacks',
  templateCategorySpecialty: 'Speciaal',
  skyblock: 'SkyBlock',
  ...
  streamLive: 'Live',
  streamReconnecting: 'Opnieuw verbinden...',
  streamOffline: 'Stream offline',
  streamError: 'Fout in livestream',
